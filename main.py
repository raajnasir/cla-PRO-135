...
for star_data in low_gravity_star:
    if star_data < 100:
        star_distance.append(star_data)
print(len(star_distance))

star_gravity =[]
for star_data in star_gravity:
    if star_data > 150 or star_data < 350:
        star_gravity.append(star_data)
print(len(star_gravity))



fig = px.bar(x = star_names, y = star_masses)
fig = px.bar(x = star_names, y = star_radiuses)
fig = px.bar(x = star_names, y = star_distance)
fig = px.bar(x = star_names, y = star_gravity)
